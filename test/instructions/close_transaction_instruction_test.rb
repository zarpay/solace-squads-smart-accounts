...
describe Solace::SquadsSmartAccounts::Instructions::CloseTransactionInstruction do
  let(:klass) { Solace::SquadsSmartAccounts::Instructions::CloseTransactionInstruction }
