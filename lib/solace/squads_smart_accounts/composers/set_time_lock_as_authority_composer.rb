...
module Solace
  module Composers
    ...
    #
    # Sets the time lock of a controlled smart account. Only the account's
    ...
    class SquadsSmartAccountsSetTimeLockAsAuthorityComposer < Base
      ...
      #
      # @return [Integer] Seconds between approval and execution
      def time_lock
        params[:time_lock]
      end
